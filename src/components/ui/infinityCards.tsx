...
import { BannerComponentProps, cn } from "../../utilities/utilities";
  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full flex-shrink-0 rounded-md border border-purple-500 px-2 py-3"
            style={{
              background:
